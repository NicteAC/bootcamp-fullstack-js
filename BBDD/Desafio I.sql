...
insert into post (
	...
	contenido,
	descripcion
) values (1, 'Pamela','2022-06-28' , 'Estamos en busqueda de un Front-End', 'Front-End');
insert into post (
	id,
	nombre_usuario,
	fecha_creacion,
	contenido,
	descripcion
)values (2, 'Pamela', '2022-06-28', 'Estamos en busqueda de un Back-End', 'Back-End');
insert into post (
	id,
	nombre_usuario,
	fecha_creacion,
	contenido,
	descripcion
)values (3, 'Carlos', '2022-07-02', 'Busco trabajo como Full-Stack', 'FullStack');
...
update post set titulo='Oferta laboral' where id='1';
update post set titulo='Oferta laboral' where id='2';
update post set titulo='Oferta laboral' where id='3';
...
insert into post (
	...
	descripcion,
	titulo
)values (4, 'Pedro', '2022-07-05', 'Busco compañeros para aprender CSS', 'Aprende CSS', 'Sesiones de estudio');
insert into post (
	id,
	nombre_usuario,
	fecha_creacion,
	...
	descripcion,
	titulo
)values (5, 'Pedro', '2022-07-05', 'Busco compañeros para aprender JS', 'Aprende JS', 'Sesiones de estudio');
...
id,
	...
	descripcion,
	titulo
)values (6, 'Pedro', '2022-07-10', 'Busco trabajo como Front-End', 'Front-End', 'Oferta laboral');
--Parte 2
